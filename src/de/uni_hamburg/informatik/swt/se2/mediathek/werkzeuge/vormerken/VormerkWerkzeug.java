...
public class VormerkWerkzeug {
	 ...
	 */
	public VormerkWerkzeug(MedienbestandService medienbestand, KundenstammService kundenstamm,
		...
		// UI wird erzeugt.
		_vormerkUI = new VormerkUI(_kundenAuflisterWerkzeug.getUIPanel(), _medienAuflisterWerkzeug.getUIPanel(),
